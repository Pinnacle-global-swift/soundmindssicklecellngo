...
export const metadata = {
  title: "Terms of Use | SickleCell Info",
  description: "Terms and conditions governing the use of the SickleCell Info website.",
}
    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="prose prose-lg max-w-none">
          <p>
            Welcome to SickleCell Info. By accessing this website, you agree to be bound by these Terms of Use, all
          ...
          <p>
            Permission is granted to temporarily download one copy of the materials on SickleCell Info's website for
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Attempt to decompile or reverse engineer any software contained on SickleCell Info's website</li>
            <li>Remove any copyright or other proprietary notations from the materials</li>
            <li>Transfer the materials to another person or "mirror" the materials on any other server</li>
          </ul>
          <p>
            This license shall automatically terminate if you violate any of these restrictions and may be terminated by
            SickleCell Info at any time. Upon terminating your viewing of these materials or upon the termination of
          ...
          <p>
            The materials on SickleCell Info's website are provided on an 'as is' basis. SickleCell Info makes no
            warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without
            limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or
            non-infringement of intellectual property or other violation of rights.
          </p>
          <p>
            Further, SickleCell Info does not warrant or make any representations concerning the accuracy, likely
          ...
          <p>
            In no event shall SickleCell Info or its suppliers be liable for any damages (including, without limitation,
            damages for loss of data or profit, or due to business interruption) arising out of the use or inability to
            use the materials on SickleCell Info's website, even if SickleCell Info or a SickleCell Info authorized
            representative has been notified orally or in writing of the possibility of such damage.
          </p>

          <h2 className="text-2xl font-bold text-brand-green mt-8 mb-4">Accuracy of Materials</h2>
          <p>
            The materials appearing on SickleCell Info's website could include technical, typographical, or photographic
            errors. SickleCell Info does not warrant that any of the materials on its website are accurate, complete, or
            current. SickleCell Info may make changes to the materials contained on its website at any time without
            notice. However, SickleCell Info does not make any commitment to update the materials.
          </p>

          <h2 className="text-2xl font-bold text-brand-green mt-8 mb-4">Links</h2>
          <p>
            SickleCell Info has not reviewed all of the sites linked to its website and is not responsible for the
            contents of any such linked site. The inclusion of any link does not imply endorsement by SickleCell Info of
            the site. Use of any such linked website is at the user's own risk.
          </p>

          <h2 className="text-2xl font-bold text-brand-green mt-8 mb-4">Modifications</h2>
          <p>
            SickleCell Info may revise these terms of service for its website at any time without notice. By using this
